...
const { aplicarMultasAutomaticamente } = require("./services/multasService");
const { verificarEAdicionarColunaDataDevolvido } = require("./models/createTables");
const dbInitializer = require("./models/initDb");
...
aplicarMultasAutomaticamente(); // Executa uma vez na inicialização

// Cron para rodar todos os dias à meia-noite
cron.schedule("0 0 * * *", async () => {
  await aplicarMultasAutomaticamente();
  console.log("🎯 Verificação de multas executada (CRON)");
});
...
app.use("/observacoes-devolucoes", require("./routes/observacoes"));
